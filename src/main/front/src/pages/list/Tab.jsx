...
const Tab = () => {
  ...
  const [menuArr, setMenuArr] = useState([
    { name: 'Tab1', content: 'Tab menu ONE', list: ['Item 1', 'Item 2', 'Item 3'] },
    { name: 'Tab2', content: 'Tab menu TWO', list: ['Item A', 'Item B', 'Item C'] },
    { name: 'Tab3', content: 'Tab menu THREE', list: ['Item X', 'Item Y', 'Item Z'] },
  ]);
  ...
  const handleAddTab = (newTabName) => {
    ...
    setMenuArr([...menuArr, { name: newTabName, content: newTabContent, list: newTabList }]);
    setIsModalOpen(false);
  };
